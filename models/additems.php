...
<form method="POST" action="items/additems.php" enctype="multipart/form-data">
<div class="row">
<div class="col-lg-2">
...
<button type="submit" name="btnsave" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-disk"></span> Save</a>
</form>
</div>
