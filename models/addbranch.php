...
<center><h4 class="modal-title" id="myModalLabel">Add New Branch</h4></center>
</div>
<div class="modal-body">
<div class="container-fluid">
<form method="POST" action="branch/addbranch.php">
<div class="row">
<div class="col-lg-2">
...
<div class="row">
<div class="col-lg-2">
<label class="control-label" style="position:relative; top:7px;">Branch Adress:</label>
</div>
<div class="col-lg-10">
