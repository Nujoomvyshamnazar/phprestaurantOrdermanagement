...
<html lang="en">
                              ...
                              <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <ul class="panel-controls">
                                       ...
                                       <a href="#addnew" data-toggle="modal" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Add New</a>
    ...
    $db = $database->openConnection();
                           ...
                           $sql = "select `id` as id,`name` as name,`email` as email,`password` as pd,user_type.User_group_name AS gpname  from `tbl_registered_users` LEFT JOIN user_type ON user_type.user_type_id=tbl_registered_users.user_type";
                           $user = $db->query($sql);
